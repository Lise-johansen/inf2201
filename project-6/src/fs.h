...
/* Magic number */
#define S_MAGIC 47376347

#define CAT (MODE_WRONLY | MODE_CREAT | MODE_TRUNC)
/*Map to disk*/
#define S_SUP_BLK os_size + 2
#define S_DISK_BITMAP_POS os_size + 3
#define S_INODE_POS os_size + 4
#define S_DATA_BLK os_size + 24

/*Size of file*/
// #define M_FILE_SIZE BLOCK_SIZE * (INODE_NDIRECT + (BLOCK_SIZE / sizeof(blknum_t)))
